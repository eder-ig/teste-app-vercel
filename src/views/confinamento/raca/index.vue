<template>
  <pagina
    ...
    subtitulo="Pagina de cadastro e manutenção de raça"
    titulo-toolbar="Cadastro de Raças"
    titulo="Raça"
    fechar
...
export default {
  ...
  computed: {
    ...mapState("paginaConfinamentoRaca", ["registros", "propriedadeDropdown"]),
    optionsFilter() {
      return {
        adicionar: true,
  ...
  methods: {
    ...mapActions("paginaConfinamentoRaca", [
      "listar",
      "exibir",
      "editar",
      "salvar",
