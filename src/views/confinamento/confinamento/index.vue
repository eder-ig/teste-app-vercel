<template>
  <pagina
    ...
    subtitulo="Cadastro de confinamento"
    titulo-toolbar="Cadastro de Confinamento"
    titulo="Confinamento"
    fechar
  ...
  >
    ...
    <template slot="listagem">
      ...
      <tabela
        ...
        height-auto
        toolbar-grid
        titulo="Listagem dos Confinamentos"
...
export default {
  name: "PaginaCadastroConfinamento",
  ...
  computed: {
    ...mapState("paginaConfinamentoConfinamento", [
      "registros",
      "propriedadeDropdown",
    ]),
    optionsFilter() {
  ...
  methods: {
    ...mapActions("paginaConfinamentoConfinamento", [
      "listar",
      "exibir",
      "editar",
      "salvar",
    ...
    async salvarRegistro() {
      if (await this.$refs.observer.validate()) {
        ...
        const form = {
          ...
          propriedadeId: this.formulario.propriedadeId || undefined,
        };
        let res;
