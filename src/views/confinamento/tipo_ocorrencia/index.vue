<template>
  <pagina
    ...
    subtitulo="Casastro de tipo de ocorrência"
    titulo-toolbar="Novo Tipo de Ocorrência"
...
export default {
  name: "PaginaCadastroTipoOcorrencia",
  ...
  computed: {
    ...mapState("paginaTipoOcorrencia", ["registros"]),
    optionsFilter() {
      return {
        adicionar: true,
  ...
  methods: {
    ...mapActions("paginaTipoOcorrencia", [
      "listar",
      "exibir",
      "editar",
      "salvar",
